...
public class BrowserUtils {
    ...
    Arg3: exceptInTitle to be compared against actualTitle
    ...
    /*
    Creating the utility method for ExplicitWait, so we don't to repeat the lines
     */
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropdownElement){
        ...
        List<String> actualOptionsAssString = new ArrayList<>();

        for (WebElement each : actualOptionsAsWebElement) {
            actualOptionsAssString.add(each.getText());

        }

        return actualOptionsAssString;
